...
export const templates: Template[] = [
  ...
  },
  {
    ...
    content: `<h3>TITLE TEXT</h3><div></div><div class="sample-image-container"><img class="fair-data" src="/images/sample.png" /></div>`,
    component: TitleImageSlide,
  },
  {
    name: "Image title slide",
    content: `<div class="sample-image-container"><img class="fair-data" src="/images/sample.png" /></div><h3>TITLE TEXT</h3>`,
    component: ImageTitleSlide,
  },
  {
    name: "Two-column image slide",
    content: `<div class='two-column'><div class='col'><h2>Left column</h2><p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Excepturi
    perferendis amet minus minima.</p></div><div class='col'><div class="sample-image-container"><img class="fair-data" src="/images/sample.png" /></div></div></div>`,
